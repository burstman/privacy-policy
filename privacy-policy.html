...
<body>
    ...
    <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection
        ...
        the
        <a href="https://www.privacypolicies.com/privacy-policy-generator/" target="_blank">Privacy Policy
            Generator</a>.
    </p>
    ...
    <ul>
        ...
        <li>
            <p><strong>Application</strong> refers to analyses perfomance, the software program provided by the Company.
            </p>
        </li>
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or
                &quot;Our&quot; in this Agreement) refers to analyses perfomance.</p>
        </li>
        <li>
    ...
    <ul>
        <li>By email: hamedflissi@gmail.com</li>
    </ul>
</body>
